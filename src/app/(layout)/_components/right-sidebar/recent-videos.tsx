...
const RecentVideos = () => {
  const recentVideosData: IRecentVideo[] = [
    {
      title:
        "İstanbul Depremine Hazırlıklı mıyız? @AyhanTarakci @MesutCevik @psy.cevdet.acarsoy",
    ...
    {
      title:
        "İstanbul Depremi Ne Kadar Etkili Olabilir? @technopat @umutayildiz",
    ...
    {
      title:
        "Müzik Duygu Durumumuzu Etkiler mi?  @TevfikUyar1 @acikbilimtv @MuzafferCorlu",
    ...
    {
      title:
        "Enkaz Altındaki İnsanların Tespiti Nasıl Yapılır? @FRPNETVideo @evrimagaci @technopat",
  ...
  return (
    <Card className="col-span-3">
      <CardHeader className="!pb-3">
        ...
        <CardDescription>
          GelecekBilim'de yayınlanan son 5 video.
        </CardDescription>
      </CardHeader>
...
RecentVideos.Item = ({ video }: { video: IRecentVideo }) => (
  <div className="flex cursor-pointer items-center">
    ...
    <div className="ml-4 space-y-1">
      <p className="text-muted line-clamp-2 text-ellipsis text-sm">
        {video.title}
      </p>
